  ...
  const updateStakingContractInfoRecord = async () => {
    ...
    try {
      ...
      setStakingContractInfoRecord({
        [StakingProgramId.PearlAlpha]: alphaInfo,
        [StakingProgramId.PearlBeta]: betaInfo,
        [StakingProgramId.PearlBeta2]: beta2Info,
        [StakingProgramId.PearlBetaMechMarketplace]: betaMechMarketplaceInfo,
      });
